  ...
  return (
    <section
      className={`fixed top-0 left-0 bottom-0 right-0 bg-red flex bg-black/40 justify-center items-center transition-opacity z-20 ${
        isShowedForm ? "opacity-100 visible" : "opacity-0 invisible"
      }`}
    >
      <form
      ...
      >
        ...
        <div className="grid gap-1">
          <label className="text-xs font-semibold" htmlFor="model">
        ...
        <div className="grid gap-1">
          <label className="text-xs font-semibold" htmlFor="color">
        ...
        <div className="grid gap-1">
          <label className="text-xs font-semibold" htmlFor="mileage">
            Mileage <span className="text-red-500">*</span>
          </label>
          <input
            placeholder="Example: 4000"
            className="border-[1px] rounded-sm bg-gray-100 p-1 focus:ring-1 focus:ring-primary-color placeholder:text-xs focus:border-primary-color"
            id="mileage"
            type="number"
            {...register("mileage", {
              required: "This field is required",
        ...
        <div className="grid gap-1">
          <label className="text-xs font-semibold" htmlFor="condition">
        ...
        <div className="grid gap-1">
          ...
          <input
            ...
            id="image"
            type="text"
            placeholder="Image formats: jpg, jpeg, gif or png"
            {...register("image", {
              required: "This field is required",
              pattern: {
        ...
        <div className="grid gap-1">
          <label className="text-xs font-semibold" htmlFor="cylinderCapacity">
            Cylinder Capacity
          </label>
          <input
            placeholder="only for motorcycles"
            className="placeholder:text-xs border-[1px] rounded-sm bg-gray-100 p-1 focus:ring-1 focus:ring-primary-color focus:border-primary-color"
            id="cylinderCapacity"
            type="number"
        ...
        <div className="grid gap-1">
          <label className="text-xs font-semibold" htmlFor="speeds">
            Speeds
          </label>
          <input
            placeholder="only for motorcycles"
        ...
        <button className="bg-primary-color text-white p-2 text-sm border-2 border-transparent hover:text-[0.9rem] hover:border-secondary-color transition-colors rounded-md sm:max-w-max sm:mx-auto sm:px-8">
          {isVehicleIdToEdit ? "Save changes" : "Register vehicle"}
        </button>
      </form>
    </section>
  );
